...
class Video_flow():
    def __init__(self, finger_list, video_url='', streamID=-1,
...
class Offline_Process():
    def __init__(self, offline_data, offline_audio_thd=700000) -> None:
    ...
    def get_offline_finger(self):
        ...
        for data in self.offline_data:
            ...
            finger = data['finger']
            streamID += 1
            video_flow = Video_flow(list(map(int, finger)), video_url, streamID)
...
class Markov_alg():
    def __init__(self, online_chunk_list, offline_data, offline_audio_thd, high_orders, high_bins_count, high_win_size,
        ...
        # 获取指纹数据
        finger_data = Offline_Process(offline_data, offline_audio_thd)
